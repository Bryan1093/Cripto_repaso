...
function renderMatching(question) {
    ...
    if (question.blanks) {
        ...
        // Professional table layout for pair matching
        const instruction = document.createElement('p');
        ...
        if (question.options && question.options.length > 0) {
            // Create table for dropdown matching
            ...
            question.pairs.forEach((pair, index) => {
                ...
                descCell.textContent = pair.description;
            ...
            // Fallback to text inputs if no options
            question.pairs.forEach((pair, index) => {
